...
.page{width:210mm;min-height:297mm;padding:0;position:relative;background:${t.fondo}}
.header{background:linear-gradient(135deg,${t.fondoOscuro} 0%,${t.fondo} 40%,${lightBg?"#F3F4F6":"#1B2D45"} 100%);padding:30px 38px 24px;border-bottom:3px solid ${t.acento};position:relative;overflow:hidden}
...
.presup-bar{background:${sectionBg};border:1px solid ${borderColor};border-radius:10px;margin:20px 38px 0;padding:16px 22px;display:flex;justify-content:space-between;align-items:center}
...
.presup-titulo{font-size:13px;color:${textMain};font-weight:600;max-width:55%;text-align:center;line-height:1.4}
.presup-fecha{font-size:10px;color:${textSoft};text-align:right}
.presup-fecha span{font-size:14px;color:${textMain};font-weight:600;display:block;margin-top:2px}
.info-cards{display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin:16px 38px 0}
.info-card{background:${cardBg};border:1px solid ${borderColor};border-radius:8px;padding:14px 16px}
.info-card-label{font-size:9px;color:${t.acento};text-transform:uppercase;letter-spacing:1.5px;font-weight:700;margin-bottom:6px}
.info-card-value{font-size:13px;color:${textMain};font-weight:500;line-height:1.5}
.content{padding:0 38px 120px}
...
.objeto-box{background:${sectionBg};border:1px solid ${borderColor};border-radius:10px;padding:18px 22px;font-size:12.5px;color:${textMuted};line-height:1.7;text-align:justify}
.responsabilidad-box{background:${cardBg};border:1px solid ${borderColor};border-left:3px solid ${t.acento};border-radius:0 8px 8px 0;padding:16px 20px;font-size:11.5px;color:${textSoft};line-height:1.7;text-align:justify}
.honorarios-box{background:linear-gradient(135deg,${t.fondoOscuro},${sectionBg});border:2px solid ${t.dorado}44;border-radius:12px;padding:24px;display:flex;justify-content:space-between;align-items:center;margin-top:8px}
.honorarios-label{font-size:10px;color:${t.dorado};text-transform:uppercase;letter-spacing:2px;font-weight:700;margin-bottom:4px}
.honorarios-monto{font-size:28px;font-weight:900;color:${t.dorado}}
.honorarios-letras{font-size:11px;color:${textSoft};margin-top:4px;font-style:italic}
...
.footer{position:fixed;bottom:0;left:0;right:0;background:${t.fondoOscuro};border-top:2px solid ${t.acento};padding:14px 38px;display:flex;justify-content:space-between;align-items:center}
...
<div class="page">
  ...
  <div class="content">
    ...
    <div class="section-header"><div class="section-header-text">Alcance del Servicio</div><div class="section-header-line"></div></div>
    ${serviciosHTML}
    ...
    <div class="honorarios-box">
      <div><div class="honorarios-label">Honorarios Profesionales</div><div class="honorarios-monto">${formatCurrency(honorarios)}</div><div class="honorarios-letras">Pesos ${montoEnLetras} – Precio total de los ${servicios.length} trabajos</div></div>
